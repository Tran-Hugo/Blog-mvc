...
<main>
  <div class="container">
    ...
    <?php else: ?>
    <h1 class="page-title">Le monde des comics</h1>
    <!-- <div class="parallax-container">
      <div class="parallax"><img class="responsive-img hoverable" src="../static/img/comics.jpg"></div>
    </div> -->
    <!-- <img class="responsive-img hoverable" src="../static/img/comics.jpg"> -->
